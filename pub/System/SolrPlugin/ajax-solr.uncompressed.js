...
(function(a){AjaxSolr.Helpers={getUniqueID:function(){var c=new Date().getTime().toString(32),b;for(b=0;b<5;b++){c+=Math.floor(Math.random()*65535).toString(32)}return c},build:function(b){a.fn["solr"+b]=function(c,d){return this.each(function(){var g=a(this),f=g.data("field"),h=g.attr("id"),e;if(typeof(h)==="undefined"){h=AjaxSolr.Helpers.getUniqueID();g.attr("id",h)}e=new AjaxSolr[b]({id:h,target:"#"+h,field:f,options:d});g.data("widget",e);c.addWidget(e)})}}}})(jQuery);var _=function(a,b){b=b||"default";return AjaxSolr.Dicts[b].get(a)};(function(a){AjaxSolr.Dictionary=function(f,e){var c=this,b=a(f),d=a.extend({},b.data(),e);c.id=b.attr("id")||d.id||"default";c.data={};c.container=b;c.opts=d;c.init()};AjaxSolr.Dictionary.prototype.init=function(){var b=this;b.text=b.container.text();b.data=a.parseJSON(b.text)};AjaxSolr.Dictionary.prototype.get=function(d){var b=this,e,c;d=d.replace(/^\s*(.*?)\s*$/,"$1");e=b.data[d];if(typeof(e)!=="undefined"){return e}if(typeof(b.opts.subDictionary)==="undefined"){return d}c=AjaxSolr.Dicts[b.opts.subDictionary];if(typeof(c)!=="undefined"){return c.get(d)}return d};AjaxSolr.Dictionary.prototype.set=function(c,d){var b=this;c=c.replace(/^\s*(.*?)\s*$/,"$1");b.data[c]=d};a(function(){var b;AjaxSolr.Dicts={};a(".solrDictionary").each(function(){var c=new AjaxSolr.Dictionary(this);if(!b){b=c}AjaxSolr.Dicts[c.id]=c});AjaxSolr.Dicts["default"]=AjaxSolr.Dicts["default"]||b})})(jQuery);