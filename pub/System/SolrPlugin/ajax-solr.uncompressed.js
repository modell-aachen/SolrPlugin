...
(function(a){AjaxSolr.Helpers={getUniqueID:function(){var c=new Date().getTime().toString(32),b;for(b=0;b<5;b++){c+=Math.floor(Math.random()*65535).toString(32)}return c},build:function(b){a.fn["solr"+b]=function(c,d){return this.each(function(){var g=a(this),f=g.data("field"),h=g.attr("id"),e;if(typeof(h)==="undefined"){h=AjaxSolr.Helpers.getUniqueID();g.attr("id",h)}e=new AjaxSolr[b]({id:h,target:"#"+h,field:f,options:d});g.data("widget",e);c.addWidget(e)})}}}})(jQuery);var _;(function(a){AjaxSolr.Dictionary={data:{},init:function(b){AjaxSolr.Dictionary.data=a.parseJSON(a(b).text())},_:function(b){b=b.replace(/^\s*(.*?)\s*$/,"$1");return AjaxSolr.Dictionary.data[b]?AjaxSolr.Dictionary.data[b]:b}};a(function(){AjaxSolr.Dictionary.init(".solrDictionary");_=AjaxSolr.Dictionary._})})(jQuery);