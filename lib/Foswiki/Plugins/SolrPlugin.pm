...
'Enterprise Search Engine for Foswiki based on [[http://lucene.apache.org/solr/][Solr]]';
...
sub initPlugin {
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            ...
            return getSearcher($session)
              ->handleSOLRSEARCH( $params, $theWeb, $theTopic );
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            ...
            return getSearcher($session)
              ->handleSOLRFORMAT( $params, $theWeb, $theTopic );
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            ...
            return getSearcher($session)
              ->handleSOLRSIMILAR( $params, $theWeb, $theTopic );
        }
    );
    ...
    Foswiki::Func::registerTagHandler(
        ...
        sub {
            ...
            return getSearcher($session)
              ->handleSOLRSCRIPTURL( $params, $theWeb, $theTopic );
        }
    );
...
sub getSearcher {
    ...
    unless ($searcher) {
        ...
        $searcher = $searcher{ $Foswiki::cfg{DefaultUrlHost} } =
          Foswiki::Plugins::SolrPlugin::Search->new(@_);
    }
...
sub getIndexer {
    ...
    unless ($indexer) {
        ...
        $indexer = $indexer{ $Foswiki::cfg{DefaultUrlHost} } =
          Foswiki::Plugins::SolrPlugin::Index->new(@_);
    }
...
sub searchCgi {
    ...
    my $template = $Foswiki::cfg{SolrPlugin}{SearchTemplate}
      || 'System.SolrSearchView';
